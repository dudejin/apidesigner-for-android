 ...
 * @version 1.0
 */
public class APIRequsetException extends Exception {
    ...
    public APIRequsetException(int errorCode, String message) {
        super(message);
        this.errorCode = errorCode;
    }

    public APIRequsetException(int errorCode, Exception exception) {
        super();
